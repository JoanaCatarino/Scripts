# -*- coding: utf-8 -*-
"""
Created on Thu Nov 11 10:55:12 2021

@author: joana
"""

"""
Created on Fri Nov 26 10:29:02 2021
By: Joana Catarino
"""
...
import numpy as np
from pupil_analyses import get_dlc_XYs
import matplotlib.pyplot as plt
#from scipy.stats import zscore (see Guido's Github)
...
eids, info = one.search(task_protocol='ephys', dataset=['_ibl_leftCamera.dlc.pqt'],
                        details=True)

times, XYs = get_dlc_XYs(eids[0], one=one)
...
def get_dlc_XYs(eid, video_type='left', one=None):
    ...
    cam = one.load_dataset(eid, dataset='_ibl_leftCamera.dlc.pqt')
